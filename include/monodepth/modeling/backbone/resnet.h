...
class BottleneckImpl : public torch::nn::Module{
  ...
  private:
    monodepth::layers::Conv2d conv1_{nullptr}, conv2_{nullptr}, conv3_{nullptr};
    monodepth::layers::FrozenBatchNorm2d bn1_{nullptr}, bn2_{nullptr}, bn3_{nullptr};
...
class BaseStemImpl : public torch::nn::Module{
  ...
  private:
    monodepth::layers::Conv2d conv1_{nullptr};
    monodepth::layers::FrozenBatchNorm2d bn1_{nullptr};
};
