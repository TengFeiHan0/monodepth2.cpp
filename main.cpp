...
int main(int argc,char**argv)
{
    ...
    auto outputs_tu = outputs.toTuple();//this model return four disp images with different sizes.
    auto tensor_output = outputs_tu->elements()[3].toTensor().to(at::kCPU);//use the biggest disp 
