...
//     for(auto i : module.named_parameters()){
//       names_in_pth.push_back(i.name);
//     }
//     for(auto i : module.named_attributes()){
//       names_in_pth.push_back(i.name);
//     }
//     std::cout << "load end\n";
...
//       for(auto& name : names_in_pth){
//         if(i.key().find(name) != std::string::npos){
//           //auto param = module.named_buffers(name);
//          // assert(param.has_value());
//          // i.value().copy_(param->value().toTensor());
//           checker = false;
//           std::cout << i.key() << " loaded from " << name << "\n";
...
//     auto buffer = module.named_buffers("iteration");
...
//       std::cout << "Load weight into memory\n";
//       std::vector<std::string> names_in_pth;
//       for(auto i : module.parameters()){
//         names_in_pth.push_back(i.name());
//       }
//       for(auto i : module.attributes()){
//         names_in_pth.push_back(i.name());
//       }
//       std::cout << "load end\n";
...
//         for(auto& name : names_in_pth){
//           if(i.key().find(name) != std::string::npos){
//             auto param = module.named_parameters(name);
//             assert(param.has_value());
//             i.value().copy_(param->value().toTensor());
//             checker = false;
//             std::cout << i.key() << " loaded from " << name << "\n";
